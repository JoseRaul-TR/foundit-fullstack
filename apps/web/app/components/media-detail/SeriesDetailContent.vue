...
const posterUrl = computed(() => tmdbImage(series.value?.posterPath, 500));
const backdropUrl = computed(() => tmdbImage(series.value?.backdropPath, 1280));
...
const backdropSrcSet = computed(() =>
  tmdbImageSrcset(series.value?.backdropPath, [780, 1280]),
);
</script>
