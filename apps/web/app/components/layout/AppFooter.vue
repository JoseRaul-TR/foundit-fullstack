...
<template>
  <footer class="border-t border-border bg-surface">
    <div
      ...
      <div class="flex flex-col items-center gap-1 text-center lg:flex-1 lg:items-start lg:text-left">
        <NuxtLink :to="localePath('/')" class="flex items-center gap-2 rounded-lg transition hover:brightness-125">
          <span class="h-6 w-6 shrink-0 rounded-md bg-[linear-gradient(45deg,_#e8a33d_14.286%,_#c9791f_85.714%)]" />
      ...
      <div class="flex flex-wrap items-center justify-center gap-4 lg:justify-end">
        <a href="https://github.com/JoseRaul-TR/foundit-fullstack" target="_blank" rel="noopener noreferrer"
        ...
        <div ref="languageWrapperRef" class="relative">
          ...
          <LanguageMenu v-if="languageMenuOpen" class="absolute bottom-full right-0 z-50 mb-2"
