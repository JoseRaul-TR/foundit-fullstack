...
<template>
  <a
    ...
    class="fixed bottom-[calc(1rem+env(safe-area-inset-bottom))] right-4 z-30 flex items-center gap-2 rounded-full border border-brand bg-brand px-3 py-2.5 text-sm font-semibold text-page shadow-lg transition hover:brightness-110 sm:px-4"
  >
    <svg
